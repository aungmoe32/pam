        ...
        <div class="grow m-auto max-w-full p-8 bg-gray-800 rounded-lg shadow-lg w-96 text-gray-200">
            ...
            <div>
                <?php $__currentLoopData = $todos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $todo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex items-center">
                        <span
                            class="flex items-center justify-center w-5 h-5  border-2 border-gray-500 rounded-full <?php echo e($todo->checked ? 'bg-[#10B981] border-[#10B981] text-[#fff]' : 'text-transparent'); ?> ">
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/aungmoemyintthu/Desktop/phpLearn/mvc/resources/views/pages/home.blade.php ENDPATH**/ ?>