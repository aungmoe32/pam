        ...
        <div class="grow m-auto max-w-full p-8 bg-gray-800 rounded-lg shadow-lg w-96 text-gray-200">
            ...
            <div>
                @foreach ($todos as $todo)
                    <div class="flex items-center">
                        <span
                            class="flex items-center justify-center w-5 h-5  border-2  rounded-full {{ $todo->checked ? 'bg-[#10B981] border-[#10B981] text-[#fff]' : 'border-gray-500 text-transparent' }} ">
                        ...
                        <span class="ml-3 p-2 {{ $todo->checked ? 'line-through' : '' }}  ">
                            {{ $todo->title }}
                        </span>
                        <div class="grow"></div>
